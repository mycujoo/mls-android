package tv.mycujoo.mls.tv.internal.presenter;
...
public class MLSPlaybackTransportRowPresenter extends PlaybackRowPresenter {
    ...
    private final LiveBadgeStateHandler liveBadgeStateHandler;
    ...
    public class ViewHolder extends PlaybackRowPresenter.ViewHolder implements PlaybackSeekUi {
        ...
        MLSPlaybackTransportRowPresenter.BoundData mControlsBoundData = new MLSPlaybackTransportRowPresenter.BoundData();
        MLSPlaybackTransportRowPresenter.BoundData mSecondaryBoundData = new MLSPlaybackTransportRowPresenter.BoundData();
        ...
        public ViewHolder(View rootView, Presenter descriptionPresenter) {
            ...
            mLiveBadgeLayout = ((FrameLayout) rootView.findViewById(R.id.tvController_liveBadgeLayout));
            mLiveBadgeLayout.setOnClickListener(v -> {
                liveBadgeStateHandler.setLiveMode(MLSPlayerView.LiveState.LIVE_ON_THE_EDGE);
                liveBadgeStateHandler.backToLive();
            });
            ...
            if (mSelectedViewHolder == null) {
                if (getOnItemViewSelectedListener() != null) {
                    getOnItemViewSelectedListener().onItemSelected(null, null,
                            MLSPlaybackTransportRowPresenter.ViewHolder.this, getRow());
                }
            } else {
                if (getOnItemViewSelectedListener() != null) {
                    getOnItemViewSelectedListener().onItemSelected(mSelectedViewHolder,
                            mSelectedItem, MLSPlaybackTransportRowPresenter.ViewHolder.this, getRow());
                }
            }
        }
    ...
    public MLSPlaybackTransportRowPresenter(LiveBadgeStateHandler liveBadgeStateHandler) {
    ...
    public void onReappear(RowPresenter.ViewHolder rowViewHolder) {
        MLSPlaybackTransportRowPresenter.ViewHolder vh = (MLSPlaybackTransportRowPresenter.ViewHolder) rowViewHolder;
        if (vh.view.hasFocus()) {
    ...
    protected void onBindRowViewHolder(RowPresenter.ViewHolder holder, Object item) {
        ...
        MLSPlaybackTransportRowPresenter.ViewHolder vh = (MLSPlaybackTransportRowPresenter.ViewHolder) holder;
        ...
        liveBadgeStateHandler.addListener(state -> setIsLive(state, vh.mLiveBadgeLayout));
    }
     ...
     */
    protected void onProgressBarClicked(MLSPlaybackTransportRowPresenter.ViewHolder vh) {
        if (vh != null) {
    ...
    protected void onRowViewSelected(RowPresenter.ViewHolder vh, boolean selected) {
        ...
        if (selected) {
            ((MLSPlaybackTransportRowPresenter.ViewHolder) vh).dispatchItemSelection();
        }
    }
