    ...
    private static class StringUri extends AbstractHierarchicalUri {
        ...
        public Builder buildUpon() {
            if (isHierarchical()) {
                return new Builder()
                        .scheme(getScheme())
                        .authority(getAuthorityPart().toString())
                        .path(getPathPart().toString())
                        .query(getQueryPart().toString())
                        .fragment(getFragmentPart().toString());
            } else {
                return new Builder()
                        .scheme(getScheme())
                        .opaquePart(getSsp().toString())
                        .fragment(getFragmentPart().toString());
            }
        }
    }
